...
public class OGATM{
    ...
    OGChecking ch = new OGChecking();

    OGSavings sav = new OGSavings();
            ...
            try {
                ...
                switch (menuSelection) {
                    ...
                    case CHECK_BAL_OPTION_CHECKING:
                        System.out.println("Your checking Account balance is: $" + ch.getCheckingBalance());
                        activeMenu = MAIN_MENU_OPTIONS;
                        break;
                    case CHECK_BAL_OPTION_SAVINGS:
                        System.out.println("Your Savings Account balance is: $" + sav.getSavingsBalance());
                        activeMenu = MAIN_MENU_OPTIONS;
                        break;
                    ...
                    case MAKE_DEPOSIT_OPTION_CHECKING:
                        ...
                        ch.deposit(inputChD);
                        System.out.println("Your updated Checking Account balance is $" + ch.getCheckingBalance());
                        activeMenu = MAIN_MENU_OPTIONS;
                        break;
                    case MAKE_DEPOSIT_OPTION_SAVINGS:
                        ...
                        System.out.println("Your updated Savings Account balance is $" + sav.getSavingsBalance());
                        activeMenu = MAIN_MENU_OPTIONS;
                        break;
